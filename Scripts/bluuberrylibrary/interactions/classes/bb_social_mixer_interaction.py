...
class BBSocialMixerInteraction(SocialMixerInteraction, BBLogMixin, BBInteractionOverridesMixin):
    ...
    def _trigger_interaction_start_event(self: 'BBSocialMixerInteraction'):
        log = self.get_log()
        try:
