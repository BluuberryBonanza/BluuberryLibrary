...
class BBExampleImmediateSuperInteraction(BBImmediateSuperInteraction):
    ...
    def get_log_name(cls) -> str:
        return 'bb_example_immediate_super_interaction'
...
# <I c="BBExampleImmediateSuperInteraction" i="interaction" m="bluuberrylibrary.examples.bb_example_immediate_super_interaction" n="BBL_Example_Immediate_Super_Interaction" s="16353877383369945099">
#   <V t="disabled" n="_saveable" />
#   <T n="cheat">True</T>
#   <T n="debug">True</T>
#   <T n="category">15787134577411302317<!--BBL_PieMenu_BluuberryLibrary--></T>
#   <T n="display_name">0xA434C86F<!--Example Immediate Super Interaction--></T>
